...
Export.table.toDrive({
  ...
  description: 'California_climate_part1',
  folder: 'GEE_California',
  fileNamePrefix: 'California_climate_part1',
  fileFormat: 'CSV'
});

Export.table.toDrive({
  collection: points_part2,
  description: 'California_climate_part2',
  folder: 'GEE_California',
  fileNamePrefix: 'California_climate_part2',
  fileFormat: 'CSV'
});